...
# TESTING DATA
tr = pd.read_csv("./python_script/Testing.csv")
...
# TRAINING DATA
df = pd.read_csv("./python_script/Training.csv")
...
def message(Symptom1, Symptom2, Symptom3, Symptom4, Symptom5):
    if (Symptom1 == "" and Symptom2 == "" and Symptom3 == "" and Symptom4 == ""
            and Symptom5 == ""):
        print("Enter 5 symptoms!")
    else:
...
if __name__ == "__main__":
    if len(sys.argv) != 6:
        print("Usage: python3 main.py symptom1 symptom2 symptom3 symptom4 symptom5")
    else:
        Symptom1 = sys.argv[1]
        Symptom2 = sys.argv[2]
        Symptom3 = sys.argv[3]
